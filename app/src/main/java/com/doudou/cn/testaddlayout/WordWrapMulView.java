 ...
 */
public class WordWrapMulView extends ViewGroup {
    private static final String TAG = WordWrapMulView.class.getSimpleName();
    ...
    public WordWrapMulView(Context context) {
        super(context);
    }

    public WordWrapMulView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public WordWrapMulView(Context context, AttributeSet attrs, int defStyle) {
